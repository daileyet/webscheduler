...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<form action="${ew:path('/setting/user/add')}" method="post"
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="email" class="form-control" id="useremail"
								name="useremail" placeholder="user email" required>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="password" class="form-control" id="userpass"
								name="userpass" placeholder="user password" required>
						</div>
					</div>
					<div class="form-group">
	...
	<script type="text/javascript"
		src="${ew:pathS('/static/js/setting.user.add.js')}"></script>
</body>
</html>