...
<link rel="stylesheet" href="${pageContext.request.contextPath}/static/font-awesome/4.6.3/css/font-awesome.min.css" crossorigin="anonymous">
	
<!-- Optional theme -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/bootstrap/3.3.7/css/bootstrap-theme.min.css"
	crossorigin="anonymous">
